...
const EyebrowsSidebar = () => {
    ...
    const handleChange = (value: string) => {
        setData({ ...data, eyebrow_colour: value });
      };
  ...
  return (
    ...
    <div className="flex flex-col gap-2">
      <div className="flex gap-2 items-center">
        <input
          type="checkbox"
          checked={data.eyebrow === "none"}
          onChange={() =>
            setData({ ...data, eyebrow: "none" })
          }
          className="size-4"
        />
      ...
      <div className="flex gap-2 items-center">
        <input
          type="checkbox"
          checked={data.eyebrow === "thick"}
          onChange={() =>
            setData({ ...data, eyebrow: "thick" })
          }
          className="size-4"
        />
        <p className="font-medium">Thick</p>
      </div>
      <div className="flex gap-2 items-center">
        <input
          type="checkbox"
          checked={data.eyebrow === "thin"}
          onChange={() =>
            setData({ ...data, eyebrow: "thin" })
          }
          className="size-4"
        />
        <p className="font-medium">Thin</p>
      </div>
...
export default EyebrowsSidebar