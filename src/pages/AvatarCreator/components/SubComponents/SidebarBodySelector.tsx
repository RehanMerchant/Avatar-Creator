    ...
    interface AvatarOptionsBoxProps {
      ...
      const AvatarOptionsBox = ({ title, image }: AvatarOptionsBoxProps) => {
        ...
        return (
          <div
            onClick={() => {
              setData({ ...data, body_type:title,head_type:"",prosthesis:"none", wings_type:"none",custom_head:"",nose:"none", hair_type:"none", eyebrow:"none", much:"none", beard:"none", dress:"none"});
            }}
